 ...
 *
 * All five screens are committed as `__tests__/fixtures/codex-0.153.0-{boot,
 * composer,idle,untrusted-boot,directory-trust}.txt` and the marker is
 * asserted against those files rather than against a literal. Only the project
 * path is substituted, and the untrusted pair's is not: it was captured in a
 * throwaway directory whose name is already neutral.
 *
