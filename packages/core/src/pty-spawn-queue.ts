 ...
 * Harnesses cold-boot simultaneously (each a full Node process) and the
 ...
 *
 * This lives on the Core, not the Panel: the cores being contended are the
 ...
 * other half keeps the Core and already-running agents responsive. Clamped
