...
//
// An *Agent* is the whole point, exactly as the systemd side installs a *user*
...
export const LAUNCH_AGENT_LABEL = "com.actana.harness";
...
export function launchdLogPath(home: string): string {
  return path.join(home, "Library", "Logs", "Actana", "harness.log");
}
...
/** Render the LaunchAgent plist for the Harness daemon. */
