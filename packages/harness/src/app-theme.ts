...
//
// Spawn-time theme hints (COLORFGBG) used to come only from the
// renderer window that initiated the spawn, read off that window's theme
// state (today the `.dark` class on <html>). With multiple windows (focus
// windows, floating panes) a
