/**
 * Harness-specific PTY environment overrides.
 *
 * OpenCode's OpenTUI stack uses two features that xterm.js (Actana Control's
...
export function harnessPtyEnvOverrides(agent: string | undefined): Record<string, string> {
  if (agent !== "opencode") return {};
  return {
    COLORTERM: "",
    OPENTUI_FORCE_EXPLICIT_WIDTH: "0",
