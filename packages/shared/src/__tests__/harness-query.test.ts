...
// them to core-link snapshots (issue 07). The Harness is the single source of
 ...
 *  consume — mirrors how the Harness's store passes its connection. */
function asQuery(db: Database.Database): HarnessQuerySqlite {
