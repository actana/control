#!/usr/bin/env node
// Compose the `SHA256SUMS` release asset covering the Harness tarballs.
//
...
//
// Usage:
//   node scripts/compose-harness-shasums.mjs --dir <dir> [--expect <n>]
//
...
import { formatShasums } from "./lib/harness-tarball.mjs";

const fail = makeFail("harness-shasums");
const log = (message) => console.log(`[harness-shasums] ${message}`);
